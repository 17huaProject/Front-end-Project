 ...
 * 
 */
public class IdGenerator24 implements Comparable<IdGenerator24> {
    ...
    public static String get() {
        return new IdGenerator24().toString();
    }

    public IdGenerator24() {
        _time = _gentime;
    ...
    public int compareTo(IdGenerator24 id) {
        if (id == null)
            return -1;
    ...
    public static void main(String[] args) {
		System.out.println(IdGenerator24.get());
		//59a2ecce91f72403e05b85f8  59a2ece12e1d240321438be6
	}
