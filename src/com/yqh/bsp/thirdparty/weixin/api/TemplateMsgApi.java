...
import com.yqh.bsp.utils.JsonUtils;
...
public class TemplateMsgApi {
    ...
    public static ApiResult send(String jsonStr) {
        String jsonResult = HttpUtil.postWithParamString(sendApiUrl + AccessToken.refreshAccessToken(), jsonStr,"UTF-8");
    ...
    public static ApiResult setIndustry(String industry_id1, String industry_id2) {
        String url = setIndustryUrl +AccessToken.refreshAccessToken();
        
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("industry_id1", industry_id1);
        params.put("industry_id2", industry_id2);
        
        String jsonResult = HttpUtil.postWithParamString(url, JsonUtils.toJson(params),"UTF-8");
        return new ApiResult(jsonResult);
    }
    ...
    public static ApiResult getIndustry() {
        return new ApiResult(HttpKit.get(getIndustryUrl + AccessToken.refreshAccessToken()));
    }
    ...
    public static ApiResult getTemplateId(String templateIdShort) {
        String url = getTemplateIdUrl + AccessToken.refreshAccessToken();
    ...
    public static ApiResult getAllTemplate() {
        return new ApiResult(HttpKit.get(getAllTemplateUrl +AccessToken.refreshAccessToken()));
    }
    ...
    public static ApiResult delTemplateById(String templateId) {
        String url = delTemplateUrl + AccessToken.refreshAccessToken();
