...
public class ApiConfig implements Serializable {
	...
	public static String appId = "wxb60b43aacf89c63e";
	public static String appSecret = "9cea7615a635b733ab62ad7567efe854";
	
	public static String mchId = PropKit.get("wx.mid");
	public static String mchKey = PropKit.get("wx.key");
	public static String wxReq = PropKit.get("wx.server");
	public static String wxNotify  = PropKit.get("wx.callback");
