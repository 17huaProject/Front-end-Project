...
public class BaseWebSessionManager extends DefaultSessionManager implements WebSessionManager {
 
    private static final Logger log = LoggerFactory.getLogger(BaseWebSessionManager.class);
 
    private Cookie sessionIdCookie;
    private boolean sessionIdCookieEnabled;
 
    public BaseWebSessionManager() {
    ...
    private Serializable getReferencedSessionId(ServletRequest request, ServletResponse response) {
        ...
        if (id != null) {
            ...
            if (id == null) {
                ...
                id = request.getParameter("access_token");
                if (id == null) {
                    //try lowercase:
